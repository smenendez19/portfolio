...
import { mdiLanguagePython, mdiCircleOffOutline, mdiLanguageJavascript, mdiLanguageGo, mdiLanguageJava, mdiConsole, mdiVuejs, mdiLanguageCss3, mdiLanguageHtml5, mdiDatabaseSearch, mdiGoogleCloud, mdiAws, mdiDocker, mdiKubernetes, mdiGit, mdiGithub, mdiMicrosoftOffice, mdiTerraform, mdiMicrosoftWindows, mdiLinux, mdiApple, mdiApi } from '@mdi/js';
